...
public class CommonAST extends CommonTree {
	 ...
	 * 
	 * @param ast
	 *            the AST tree to fill information.
	 */
	 ...
	 *            the AST tree to fill information
	 * @param astParent
	 *            the current node parent. The parent can be <code>null</code>.
	 * @param index
	 *            the current node index. Index must be 0 or higher.
	 */
	private static void fillParentInfo(CommonAST ast, CommonAST astParent, int index) {
	 ...
	 * 
	 * @param node
	 *            tree node that wrappers a Token object.
	 */
