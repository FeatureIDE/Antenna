...
public class APPParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "DOT", "COMMA",
			"SEMI", "PERCENT", "LPAR", "RPAR", "BLPAR", "BRPAR", "NOT", "XOR", "AT", "NEQ", "LT", "GT", "LTE", "GTE",
			"DEBUG", "INFO", "WARN", "ERROR", "FATAL", "DEFINE", "UNDEFINE", "IF", "ELIF", "CONDITION", "IFDEF",
			"IFNDEF", "ELIFDEF", "ELIFNDEF", "ENDIF", "ELSE", "ENDINCLUDE", "INCLUDE", "EXPAND", "MDEBUG", "ENDDEBUG",
			"UNSET", "ADD_IF_NEW", "TRUE", "FALSE", "WS", "FSLASH", "BSLASH", "ASLASH", "COLON", "DIGIT_0", "DIGIT_1",
			"CHAR", "EOL", "SYMBOL", "NUMBER", "STRING", "AND", "OR", "EQ", "'//'", "'#'" };
	...
	public APPParser(TokenStream input) {
		super(input);
		state.ruleMemo = new HashMap[18 + 1];
	}
	...
	// src/antenna/preprocessor/v3/parser/APP.g:158:1: r_boolean : ( TRUE |
	// FALSE );
	...
	// $ANTLR start ident
	// src/antenna/preprocessor/v3/parser/APP.g:159:1: ident : ( SYMBOL | STRING
	// | NUMBER | r_boolean );
	public final ident_return ident() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:159:6: ( SYMBOL | STRING
			// | NUMBER | r_boolean )
			int alt1 = 4;
			switch (input.LA(1)) {
			case SYMBOL: {
			...
			default:
				...
				NoViableAltException nvae = new NoViableAltException(
						"159:1: ident : ( SYMBOL | STRING | NUMBER | r_boolean );", 1, 0, input);
			...
			// src/antenna/preprocessor/v3/parser/APP.g:159:35: r_boolean
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, r_boolean7.getTree());
	...
	// $ANTLR start bool
	// src/antenna/preprocessor/v3/parser/APP.g:161:1: bool : ( ident | LPAR
	// expression RPAR );
	public final bool_return bool() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:161:5: ( ident | LPAR
			// expression RPAR )
			int alt2 = 2;
			...
			if (((LA2_0 >= TRUE && LA2_0 <= FALSE) || (LA2_0 >= SYMBOL && LA2_0 <= STRING))) {
				...
				NoViableAltException nvae = new NoViableAltException("161:1: bool : ( ident | LPAR expression RPAR );",
						2, 0, input);
			...
			// src/antenna/preprocessor/v3/parser/APP.g:161:7: ident
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, ident8.getTree());

			}
				break;
			case 2:
			// src/antenna/preprocessor/v3/parser/APP.g:162:9: LPAR expression
			// RPAR
			{
				root_0 = (Object) adaptor.nil();
		...
		try {
			...
			// src/antenna/preprocessor/v3/parser/APP.g:165:12: ( NOT )* bool
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, bool13.getTree());
	...
	// $ANTLR start eq_bool
	// src/antenna/preprocessor/v3/parser/APP.g:167:1: eq_bool : not_bool ( ( AT
	// | EQ | NEQ | LT | GT | LTE | GTE ) not_bool )? ;
	public final eq_bool_return eq_bool() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:167:9: ( not_bool ( ( AT
			// | EQ | NEQ | LT | GT | LTE | GTE ) not_bool )? )
			// src/antenna/preprocessor/v3/parser/APP.g:168:5: not_bool ( ( AT |
			// EQ | NEQ | LT | GT | LTE | GTE ) not_bool )?
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, not_bool14.getTree());
				// src/antenna/preprocessor/v3/parser/APP.g:168:14: ( ( AT | EQ
				// | NEQ | LT | GT | LTE | GTE ) not_bool )?
				int alt5 = 2;
				...
				switch (alt5) {
				case 1:
				// src/antenna/preprocessor/v3/parser/APP.g:168:15: ( AT | EQ |
				// NEQ | LT | GT | LTE | GTE ) not_bool
				{
					// src/antenna/preprocessor/v3/parser/APP.g:168:15: ( AT |
					...
					default:
						...
						NoViableAltException nvae = new NoViableAltException(
								"168:15: ( AT | EQ | NEQ | LT | GT | LTE | GTE )", 4, 0, input);
					...
					if (state.failed)
						return retval;
					if (state.backtracking == 0)
						adaptor.addChild(root_0, not_bool22.getTree());
	...
	// src/antenna/preprocessor/v3/parser/APP.g:170:1: and_bool : eq_bool ( AND
	// eq_bool )* ;
	public final and_bool_return and_bool() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:170:10: ( eq_bool ( AND
			// eq_bool )* )
			// src/antenna/preprocessor/v3/parser/APP.g:170:12: eq_bool ( AND
			// eq_bool )*
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, eq_bool23.getTree());
				// src/antenna/preprocessor/v3/parser/APP.g:170:20: ( AND
				// eq_bool )*
				loop6: do {
					int alt6 = 2;
					...
					switch (alt6) {
					case 1:
					// src/antenna/preprocessor/v3/parser/APP.g:170:21: AND
					// eq_bool
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, eq_bool25.getTree());
	...
	// src/antenna/preprocessor/v3/parser/APP.g:172:1: xor_bool : and_bool ( XOR
	// and_bool )* ;
	public final xor_bool_return xor_bool() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:172:10: ( and_bool ( XOR
			// and_bool )* )
			// src/antenna/preprocessor/v3/parser/APP.g:172:12: and_bool ( XOR
			// and_bool )*
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, and_bool26.getTree());
				// src/antenna/preprocessor/v3/parser/APP.g:172:21: ( XOR
				// and_bool )*
				loop7: do {
					int alt7 = 2;
					...
					switch (alt7) {
					case 1:
					// src/antenna/preprocessor/v3/parser/APP.g:172:22: XOR
					// and_bool
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, and_bool28.getTree());
	...
	// src/antenna/preprocessor/v3/parser/APP.g:174:1: expression : xor_bool (
	// OR xor_bool )* ;
	public final expression_return expression() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:174:12: ( xor_bool ( OR
			// xor_bool )* )
			// src/antenna/preprocessor/v3/parser/APP.g:174:14: xor_bool ( OR
			// xor_bool )*
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, xor_bool29.getTree());
				// src/antenna/preprocessor/v3/parser/APP.g:174:23: ( OR
				// xor_bool )*
				loop8: do {
					int alt8 = 2;
					...
					switch (alt8) {
					case 1:
					// src/antenna/preprocessor/v3/parser/APP.g:174:24: OR
					// xor_bool
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, xor_bool31.getTree());
			...
			// src/antenna/preprocessor/v3/parser/APP.g:176:12: (~ EOL )+
			{
				...
				loop9: do {
					...
					// src/antenna/preprocessor/v3/parser/APP.g:176:13: ~ EOL
					{
						...
						if ((input.LA(1) >= DOT && input.LA(1) <= CHAR)
								|| (input.LA(1) >= SYMBOL && input.LA(1) <= 61)) {
							input.consume();
							if (state.backtracking == 0)
	...
	// src/antenna/preprocessor/v3/parser/APP.g:178:1: debug_level : ( DEBUG |
	...
	public final debug_level_return debug_level() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:178:13: ( DEBUG | INFO |
			// WARN | ERROR | FATAL )
			// src/antenna/preprocessor/v3/parser/APP.g:
			{
				root_0 = (Object) adaptor.nil();
	...
	// $ANTLR start line
	// src/antenna/preprocessor/v3/parser/APP.g:180:1: line : ( ( ( prefix )=>
	// prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF | CONDITION )
	// expression ) | ( IFDEF | IFNDEF | ELIFDEF | ELIFNDEF ) SYMBOL | ( ENDIF |
	// ELSE | ENDINCLUDE ) | ( INCLUDE (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( (
	// DEBUG | MDEBUG ) ( debug_level )? ) | ENDDEBUG ) ) ( EOL | EOF ) ) ;
	public final line_return line() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:180:6: ( ( ( ( prefix
			// )=> prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF |
			// CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF | ELIFNDEF
			// ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) | ( INCLUDE (~ EOL )+ )
			// | ( EXPAND (~ EOL )+ ) | ( ( DEBUG | MDEBUG ) ( debug_level )? )
			// | ENDDEBUG ) ) ( EOL | EOF ) ) )
			// src/antenna/preprocessor/v3/parser/APP.g:181:1: ( ( ( prefix )=>
			// prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF |
			// CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF | ELIFNDEF
			// ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) | ( INCLUDE (~ EOL )+ )
			// | ( EXPAND (~ EOL )+ ) | ( ( DEBUG | MDEBUG ) ( debug_level )? )
			// | ENDDEBUG ) ) ( EOL | EOF ) )
			{
				...
				// src/antenna/preprocessor/v3/parser/APP.g:181:1: ( ( ( prefix
				// )=> prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF
				// | CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF |
				// ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) | ( INCLUDE
				// (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( ( DEBUG | MDEBUG ) (
				// debug_level )? ) | ENDDEBUG ) ) ( EOL | EOF ) )
				// src/antenna/preprocessor/v3/parser/APP.g:182:5: ( ( prefix
				// )=> prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF
				// | CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF |
				// ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) | ( INCLUDE
				// (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( ( DEBUG | MDEBUG ) (
				// debug_level )? ) | ENDDEBUG ) ) ( EOL | EOF )
				{
					// src/antenna/preprocessor/v3/parser/APP.g:182:5: ( (
					// prefix )=> prefix ( ( DEFINE define | UNDEFINE SYMBOL | (
					// IF | ELIF | CONDITION ) expression ) | ( IFDEF | IFNDEF |
					// ELIFDEF | ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE
					// ) | ( INCLUDE (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( (
					// DEBUG | MDEBUG ) ( debug_level )? ) | ENDDEBUG ) )
					// src/antenna/preprocessor/v3/parser/APP.g:183:9: ( prefix
					// )=> prefix ( ( DEFINE define | UNDEFINE SYMBOL | ( IF |
					// ELIF | CONDITION ) expression ) | ( IFDEF | IFNDEF |
					// ELIFDEF | ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE
					// ) | ( INCLUDE (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( (
					// DEBUG | MDEBUG ) ( debug_level )? ) | ENDDEBUG )
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, prefix34.getTree());
						// src/antenna/preprocessor/v3/parser/APP.g:184:13: ( (
						// DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF |
						// CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF
						// | ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) |
						// ( INCLUDE (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( (
						// DEBUG | MDEBUG ) ( debug_level )? ) | ENDDEBUG )
						int alt14 = 7;
						switch (input.LA(1)) {
						...
						default:
							...
							NoViableAltException nvae = new NoViableAltException(
									"184:13: ( ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF | CONDITION ) expression ) | ( IFDEF | IFNDEF | ELIFDEF | ELIFNDEF ) SYMBOL | ( ENDIF | ELSE | ENDINCLUDE ) | ( INCLUDE (~ EOL )+ ) | ( EXPAND (~ EOL )+ ) | ( ( DEBUG | MDEBUG ) ( debug_level )? ) | ENDDEBUG )",
									14, 0, input);
						...
						switch (alt14) {
						case 1:
						// src/antenna/preprocessor/v3/parser/APP.g:185:17: (
						// DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF |
						// CONDITION ) expression )
						{
							...
							default:
								...
								NoViableAltException nvae = new NoViableAltException(
										"185:17: ( DEFINE define | UNDEFINE SYMBOL | ( IF | ELIF | CONDITION ) expression )",
										10, 0, input);
							...
							switch (alt10) {
							case 1:
							// src/antenna/preprocessor/v3/parser/APP.g:186:17:
							// DEFINE define
							{
								...
								if (state.failed)
									return retval;
								if (state.backtracking == 0)
									adaptor.addChild(root_0, define36.getTree());

							}
								break;
							case 2:
							// src/antenna/preprocessor/v3/parser/APP.g:187:17:
							// UNDEFINE SYMBOL
							{
								...
								break;
							case 3:
							// src/antenna/preprocessor/v3/parser/APP.g:188:17:
							...
							break;
						case 2:
						// src/antenna/preprocessor/v3/parser/APP.g:189:17: (
						// IFDEF | IFNDEF | ELIFDEF | ELIFNDEF ) SYMBOL
						{
							...
							if ((input.LA(1) >= IFDEF && input.LA(1) <= ELIFNDEF)) {
								input.consume();
								if (state.backtracking == 0)
									adaptor.addChild(root_0, adaptor.create(set41));
								state.errorRecovery = false;
								state.failed = false;
							} else {
								if (state.backtracking > 0) {
							...
							break;
						case 3:
						// src/antenna/preprocessor/v3/parser/APP.g:190:17: (
						// ENDIF | ELSE | ENDINCLUDE )
						{
							...
							break;
						case 4:
						// src/antenna/preprocessor/v3/parser/APP.g:191:17: (
						// INCLUDE (~ EOL )+ )
						{
							// src/antenna/preprocessor/v3/parser/APP.g:191:17:
							// ( INCLUDE (~ EOL )+ )
							// src/antenna/preprocessor/v3/parser/APP.g:191:18:
							// INCLUDE (~ EOL )+
							{
								...
								// src/antenna/preprocessor/v3/parser/APP.g:191:26:
								// (~ EOL )+
								int cnt11 = 0;
								loop11: do {
									int alt11 = 2;
									...
									switch (alt11) {
									case 1:
									// src/antenna/preprocessor/v3/parser/APP.g:191:27:
									// ~ EOL
									{
							...
							break;
						case 5:
						// src/antenna/preprocessor/v3/parser/APP.g:192:17: (
						// EXPAND (~ EOL )+ )
						{
							// src/antenna/preprocessor/v3/parser/APP.g:192:17:
							// ( EXPAND (~ EOL )+ )
							// src/antenna/preprocessor/v3/parser/APP.g:192:18:
							// EXPAND (~ EOL )+
							{
								...
								// src/antenna/preprocessor/v3/parser/APP.g:192:25:
								// (~ EOL )+
								int cnt12 = 0;
								loop12: do {
									int alt12 = 2;
									...
									switch (alt12) {
									case 1:
									// src/antenna/preprocessor/v3/parser/APP.g:192:26:
									// ~ EOL
									{
							...
							break;
						case 6:
						// src/antenna/preprocessor/v3/parser/APP.g:193:17: ( (
						// DEBUG | MDEBUG ) ( debug_level )? )
						{
							// src/antenna/preprocessor/v3/parser/APP.g:193:17:
							// ( ( DEBUG | MDEBUG ) ( debug_level )? )
							// src/antenna/preprocessor/v3/parser/APP.g:193:18:
							// ( DEBUG | MDEBUG ) ( debug_level )?
							{
								...
								// src/antenna/preprocessor/v3/parser/APP.g:193:33:
								// ( debug_level )?
								int alt13 = 2;
								...
								switch (alt13) {
								case 1:
								// src/antenna/preprocessor/v3/parser/APP.g:193:34:
								// debug_level
								{
									...
									if (state.failed)
										return retval;
									if (state.backtracking == 0)
										adaptor.addChild(root_0, debug_level49.getTree());
							...
							break;
						case 7:
						// src/antenna/preprocessor/v3/parser/APP.g:194:17:
						// ENDDEBUG
						{
	...
	// src/antenna/preprocessor/v3/parser/APP.g:203:1: define_command : ( UNSET
	// | ADD_IF_NEW );
	public final define_command_return define_command() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:203:16: ( UNSET |
			// ADD_IF_NEW )
			// src/antenna/preprocessor/v3/parser/APP.g:
			{
				root_0 = (Object) adaptor.nil();
	...
	// src/antenna/preprocessor/v3/parser/APP.g:204:1: define_value : ( ident |
	// debug_level );
	public final define_value_return define_value() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:204:13: ( ident |
			// debug_level )
			int alt15 = 2;
			...
			if (((LA15_0 >= TRUE && LA15_0 <= FALSE) || (LA15_0 >= SYMBOL && LA15_0 <= STRING))) {
				...
				NoViableAltException nvae = new NoViableAltException("204:1: define_value : ( ident | debug_level );",
						15, 0, input);
			...
			// src/antenna/preprocessor/v3/parser/APP.g:204:15: ident
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, ident54.getTree());
			...
			// src/antenna/preprocessor/v3/parser/APP.g:204:23: debug_level
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, debug_level55.getTree());
	...
	// $ANTLR start define
	// src/antenna/preprocessor/v3/parser/APP.g:205:1: define : ( define_command
	// AT )? SYMBOL ( EQ define_value )? ;
	public final define_return define() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:205:8: ( (
			// define_command AT )? SYMBOL ( EQ define_value )? )
			// src/antenna/preprocessor/v3/parser/APP.g:205:10: ( define_command
			// AT )? SYMBOL ( EQ define_value )?
			{
				root_0 = (Object) adaptor.nil();

				// src/antenna/preprocessor/v3/parser/APP.g:205:10: (
				// define_command AT )?
				int alt16 = 2;
				...
				switch (alt16) {
				case 1:
				// src/antenna/preprocessor/v3/parser/APP.g:205:11:
				// define_command AT
				{
					...
					if (state.failed)
						return retval;
					if (state.backtracking == 0)
						adaptor.addChild(root_0, define_command56.getTree());
				...
				// src/antenna/preprocessor/v3/parser/APP.g:205:39: ( EQ
				// define_value )?
				int alt17 = 2;
				...
				switch (alt17) {
				case 1:
				// src/antenna/preprocessor/v3/parser/APP.g:205:40: EQ
				// define_value
				{
					...
					if (state.failed)
						return retval;
					if (state.backtracking == 0)
						adaptor.addChild(root_0, define_value60.getTree());
	...
	// $ANTLR start defines
	// src/antenna/preprocessor/v3/parser/APP.g:206:1: defines : ( ( EOL | EOF )
	// | define ( COMMA define )* ( EOL )? );
	public final defines_return defines() throws RecognitionException {
		...
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:206:9: ( ( EOL | EOF ) |
			// define ( COMMA define )* ( EOL )? )
			int alt20 = 2;
			...
			if ((LA20_0 == EOF || LA20_0 == EOL)) {
				...
				NoViableAltException nvae = new NoViableAltException(
						"206:1: defines : ( ( EOL | EOF ) | define ( COMMA define )* ( EOL )? );", 20, 0, input);
			...
			// src/antenna/preprocessor/v3/parser/APP.g:206:11: ( EOL | EOF )
			{
				...
				break;
			case 2:
			// src/antenna/preprocessor/v3/parser/APP.g:206:23: define ( COMMA
			// define )* ( EOL )?
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, define62.getTree());
				// src/antenna/preprocessor/v3/parser/APP.g:206:30: ( COMMA
				// define )*
				loop18: do {
					int alt18 = 2;
					...
					switch (alt18) {
					case 1:
					// src/antenna/preprocessor/v3/parser/APP.g:206:31: COMMA
					// define
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, define64.getTree());
