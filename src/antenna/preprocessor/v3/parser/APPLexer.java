...
public class APPLexer extends Lexer {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.antlr.runtime.Lexer#reportError(org.antlr.runtime.
	...
	public final void mCHAR() throws RecognitionException {
		try {
			// src/antenna/preprocessor/v3/parser/APP.g:138:15: ( ( 'a' .. 'z' |
			// 'A' .. 'Z' ) )
			// src/antenna/preprocessor/v3/parser/APP.g:138:17: ( 'a' .. 'z' |
			// 'A' .. 'Z' )
			{
		...
		try {
			...
			// '\\r\\n' )
			{
				...
				if ((LA2_0 == '\n')) {
					...
					NoViableAltException nvae = new NoViableAltException("140:7: ( '\\n' | '\\r' | '\\r\\n' )", 2, 0,
							input);
	...
	public final void mSYMBOL() throws RecognitionException {
		try {
			int _type = SYMBOL;
			// src/antenna/preprocessor/v3/parser/APP.g:143:3: ( CHAR ( CHAR |
			// DIGIT_0 | '_' | '-' | '+' | '.' | BSLASH | FSLASH | SEMI | COLON
			// )* )
			// src/antenna/preprocessor/v3/parser/APP.g:144:3: CHAR ( CHAR |
			// DIGIT_0 | '_' | '-' | '+' | '.' | BSLASH | FSLASH | SEMI | COLON
			// )*
			{
				mCHAR();
				// src/antenna/preprocessor/v3/parser/APP.g:144:8: ( CHAR |
				// DIGIT_0 | '_' | '-' | '+' | '.' | BSLASH | FSLASH | SEMI |
				// COLON )*
				loop3: do {
					int alt3 = 2;
					int LA3_0 = input.LA(1);

					if ((LA3_0 == '+' || (LA3_0 >= '-' && LA3_0 <= ';') || (LA3_0 >= 'A' && LA3_0 <= 'Z')
							|| LA3_0 == '\\' || LA3_0 == '_' || (LA3_0 >= 'a' && LA3_0 <= 'z'))) {
						alt3 = 1;
					}
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			// src/antenna/preprocessor/v3/parser/APP.g:146:8: ( ( '+' | '-' )?
			// ( DIGIT_0 )+ ( ( '.' ) ( DIGIT_0 )+ )? )
			...
			// DIGIT_0 )+ ( ( '.' ) ( DIGIT_0 )+ )?
			{
				...
				// src/antenna/preprocessor/v3/parser/APP.g:146:32: ( ( '.' ) (
				// DIGIT_0 )+ )?
				int alt7 = 2;
				...
				// DIGIT_0 )+
				{
					...
					// src/antenna/preprocessor/v3/parser/APP.g:146:38: (
					// DIGIT_0 )+
					int cnt6 = 0;
					loop6: do {
						int alt6 = 2;
						...
						switch (alt6) {
						case 1:
						// src/antenna/preprocessor/v3/parser/APP.g:146:39:
						// DIGIT_0
						{
							mDIGIT_0();
	...
	public void mTokens() throws RecognitionException {
		// src/antenna/preprocessor/v3/parser/APP.g:1:8: ( DOT | COMMA | SEMI |
		// PERCENT | LPAR | RPAR | BLPAR | BRPAR | NOT | XOR | AT | NEQ | LT |
		// GT | LTE | GTE | DEBUG | INFO | WARN | ERROR | FATAL | DEFINE |
		// UNDEFINE | IF | ELIF | CONDITION | IFDEF | IFNDEF | ELIFDEF |
		// ELIFNDEF | ENDIF | ELSE | ENDINCLUDE | INCLUDE | EXPAND | MDEBUG |
		// ENDDEBUG | UNSET | ADD_IF_NEW | TRUE | FALSE | T60 | T61 | WS |
		// ASLASH | EOL | SYMBOL | NUMBER | STRING | AND | OR | EQ )
		int alt14 = 52;
		switch (input.LA(1)) {
		case '.': {
			alt14 = 1;
				...
				case 'b': {
					...
					if ((LA14_56 == 'u')) {
						...
						if ((LA14_77 == 'g')) {
							...
							if ((LA14_98 == '+' || (LA14_98 >= '-' && LA14_98 <= ';')
									|| (LA14_98 >= 'A' && LA14_98 <= 'Z') || LA14_98 == '\\' || LA14_98 == '_'
									|| (LA14_98 >= 'a' && LA14_98 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 17;
					...
					if ((LA14_57 == 'i')) {
						...
						if ((LA14_78 == 'n')) {
							...
							if ((LA14_99 == 'e')) {
								...
								if ((LA14_123 == '+' || (LA14_123 >= '-' && LA14_123 <= ';')
										|| (LA14_123 >= 'A' && LA14_123 <= 'Z') || LA14_123 == '\\' || LA14_123 == '_'
										|| (LA14_123 >= 'a' && LA14_123 <= 'z'))) {
									alt14 = 47;
								} else {
									alt14 = 22;
								}
					...
					if ((LA14_58 == 'd')) {
						...
						if ((LA14_79 == 'e')) {
							...
							if ((LA14_100 == 'f')) {
								...
								if ((LA14_124 == '+' || (LA14_124 >= '-' && LA14_124 <= ';')
										|| (LA14_124 >= 'A' && LA14_124 <= 'Z') || LA14_124 == '\\' || LA14_124 == '_'
										|| (LA14_124 >= 'a' && LA14_124 <= 'z'))) {
									alt14 = 47;
								} else {
									alt14 = 28;
								}
				...
				case 'd': {
					...
					if ((LA14_59 == 'e')) {
						...
						if ((LA14_80 == 'f')) {
							...
							if ((LA14_101 == '+' || (LA14_101 >= '-' && LA14_101 <= ';')
									|| (LA14_101 >= 'A' && LA14_101 <= 'Z') || LA14_101 == '\\' || LA14_101 == '_'
									|| (LA14_101 >= 'a' && LA14_101 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 27;
							}
			...
			case 'n': {
				...
				case 'f': {
					...
					if ((LA14_61 == 'o')) {
						...
						if ((LA14_81 == '+' || (LA14_81 >= '-' && LA14_81 <= ';') || (LA14_81 >= 'A' && LA14_81 <= 'Z')
								|| LA14_81 == '\\' || LA14_81 == '_' || (LA14_81 >= 'a' && LA14_81 <= 'z'))) {
							alt14 = 47;
						} else {
							alt14 = 18;
						}
						...
						if ((LA14_82 == 'u')) {
							...
							if ((LA14_103 == 'd')) {
								...
								if ((LA14_126 == 'e')) {
									...
									if ((LA14_143 == '+' || (LA14_143 >= '-' && LA14_143 <= ';')
											|| (LA14_143 >= 'A' && LA14_143 <= 'Z') || LA14_143 == '\\'
											|| LA14_143 == '_' || (LA14_143 >= 'a' && LA14_143 <= 'z'))) {
										alt14 = 47;
									} else {
										alt14 = 34;
									}
			...
			if ((LA14_16 == 'a')) {
				...
				if ((LA14_44 == 'r')) {
					...
					if ((LA14_63 == 'n')) {
						...
						if ((LA14_83 == '+' || (LA14_83 >= '-' && LA14_83 <= ';') || (LA14_83 >= 'A' && LA14_83 <= 'Z')
								|| LA14_83 == '\\' || LA14_83 == '_' || (LA14_83 >= 'a' && LA14_83 <= 'z'))) {
							alt14 = 47;
						} else {
							alt14 = 19;
						}
				...
				if ((LA14_45 == 'd')) {
							...
							if ((LA14_105 == 'b')) {
								...
								if ((LA14_127 == 'u')) {
									...
									if ((LA14_144 == 'g')) {
										...
										if ((LA14_154 == '+' || (LA14_154 >= '-' && LA14_154 <= ';')
												|| (LA14_154 >= 'A' && LA14_154 <= 'Z') || LA14_154 == '\\'
												|| LA14_154 == '_' || (LA14_154 >= 'a' && LA14_154 <= 'z'))) {
											alt14 = 47;
										} else {
											alt14 = 37;
										}
					...
					case 'i': {
						...
						case 'f': {
							...
							if ((LA14_106 == '+' || (LA14_106 >= '-' && LA14_106 <= ';')
									|| (LA14_106 >= 'A' && LA14_106 <= 'Z') || LA14_106 == '\\' || LA14_106 == '_'
									|| (LA14_106 >= 'a' && LA14_106 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 31;
							}
									...
									if ((LA14_145 == 'u')) {
										...
										if ((LA14_155 == 'd')) {
											...
											if ((LA14_162 == 'e')) {
												...
												if ((LA14_167 == '+' || (LA14_167 >= '-' && LA14_167 <= ';')
														|| (LA14_167 >= 'A' && LA14_167 <= 'Z') || LA14_167 == '\\'
														|| LA14_167 == '_' || (LA14_167 >= 'a' && LA14_167 <= 'z'))) {
													alt14 = 47;
												} else {
													alt14 = 33;
												}
					...
					if ((LA14_65 == 'a')) {
						...
						if ((LA14_86 == 'n')) {
							...
							if ((LA14_108 == 'd')) {
								...
								if ((LA14_130 == '+' || (LA14_130 >= '-' && LA14_130 <= ';')
										|| (LA14_130 >= 'A' && LA14_130 <= 'Z') || LA14_130 == '\\' || LA14_130 == '_'
										|| (LA14_130 >= 'a' && LA14_130 <= 'z'))) {
									alt14 = 47;
								} else {
									alt14 = 35;
								}
			...
			case 'l': {
						...
						case 'd': {
							...
							if ((LA14_109 == 'e')) {
								...
								if ((LA14_131 == 'f')) {
									...
									if ((LA14_147 == '+' || (LA14_147 >= '-' && LA14_147 <= ';')
											|| (LA14_147 >= 'A' && LA14_147 <= 'Z') || LA14_147 == '\\'
											|| LA14_147 == '_' || (LA14_147 >= 'a' && LA14_147 <= 'z'))) {
										alt14 = 47;
									} else {
										alt14 = 29;
									}
							...
							if ((LA14_110 == 'd')) {
								...
								if ((LA14_132 == 'e')) {
									...
									if ((LA14_148 == 'f')) {
										...
										if ((LA14_157 == '+' || (LA14_157 >= '-' && LA14_157 <= ';')
												|| (LA14_157 >= 'A' && LA14_157 <= 'Z') || LA14_157 == '\\'
												|| LA14_157 == '_' || (LA14_157 >= 'a' && LA14_157 <= 'z'))) {
											alt14 = 47;
										} else {
											alt14 = 30;
										}
				...
				case 's': {
					...
					if ((LA14_67 == 'e')) {
						...
						if ((LA14_88 == '+' || (LA14_88 >= '-' && LA14_88 <= ';') || (LA14_88 >= 'A' && LA14_88 <= 'Z')
								|| LA14_88 == '\\' || LA14_88 == '_' || (LA14_88 >= 'a' && LA14_88 <= 'z'))) {
							alt14 = 47;
						} else {
							alt14 = 32;
						}
				...
				if ((LA14_48 == 'r')) {
					...
					if ((LA14_68 == 'o')) {
						...
						if ((LA14_89 == 'r')) {
							...
							if ((LA14_113 == '+' || (LA14_113 >= '-' && LA14_113 <= ';')
									|| (LA14_113 >= 'A' && LA14_113 <= 'Z') || LA14_113 == '\\' || LA14_113 == '_'
									|| (LA14_113 >= 'a' && LA14_113 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 20;
							}
				...
				case 'l': {
					...
					if ((LA14_69 == 's')) {
						...
						if ((LA14_90 == 'e')) {
							...
							if ((LA14_114 == '+' || (LA14_114 >= '-' && LA14_114 <= ';')
									|| (LA14_114 >= 'A' && LA14_114 <= 'Z') || LA14_114 == '\\' || LA14_114 == '_'
									|| (LA14_114 >= 'a' && LA14_114 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 41;
							}
				...
				case 't': {
					...
					if ((LA14_70 == 'a')) {
						...
						if ((LA14_91 == 'l')) {
							...
							if ((LA14_115 == '+' || (LA14_115 >= '-' && LA14_115 <= ';')
									|| (LA14_115 >= 'A' && LA14_115 <= 'Z') || LA14_115 == '\\' || LA14_115 == '_'
									|| (LA14_115 >= 'a' && LA14_115 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 21;
							}
							...
							if ((LA14_116 == 'i')) {
								...
								if ((LA14_136 == 'n')) {
									...
									if ((LA14_149 == 'e')) {
										...
										if ((LA14_158 == '+' || (LA14_158 >= '-' && LA14_158 <= ';')
												|| (LA14_158 >= 'A' && LA14_158 <= 'Z') || LA14_158 == '\\'
												|| LA14_158 == '_' || (LA14_158 >= 'a' && LA14_158 <= 'z'))) {
											alt14 = 47;
										} else {
											alt14 = 23;
										}
				...
				case 's': {
					...
					if ((LA14_72 == 'e')) {
						...
						if ((LA14_93 == 't')) {
							...
							if ((LA14_117 == '+' || (LA14_117 >= '-' && LA14_117 <= ';')
									|| (LA14_117 >= 'A' && LA14_117 <= 'Z') || LA14_117 == '\\' || LA14_117 == '_'
									|| (LA14_117 >= 'a' && LA14_117 <= 'z'))) {
								alt14 = 47;
							} else {
								alt14 = 38;
							}
								...
								if ((LA14_138 == 'i')) {
									...
									if ((LA14_150 == 'o')) {
										...
										if ((LA14_159 == 'n')) {
											...
											if ((LA14_165 == '+' || (LA14_165 >= '-' && LA14_165 <= ';')
													|| (LA14_165 >= 'A' && LA14_165 <= 'Z') || LA14_165 == '\\'
													|| LA14_165 == '_' || (LA14_165 >= 'a' && LA14_165 <= 'z'))) {
												alt14 = 47;
											} else {
												alt14 = 26;
											}
					...
					if ((LA14_74 == 'b')) {
						...
						if ((LA14_95 == 'u')) {
							...
							if ((LA14_119 == 'g')) {
								...
								if ((LA14_139 == '+' || (LA14_139 >= '-' && LA14_139 <= ';')
										|| (LA14_139 >= 'A' && LA14_139 <= 'Z') || LA14_139 == '\\' || LA14_139 == '_'
										|| (LA14_139 >= 'a' && LA14_139 <= 'z'))) {
									alt14 = 47;
								} else {
									alt14 = 36;
								}
									...
									if ((LA14_152 == 'n')) {
										...
										if ((LA14_160 == 'e')) {
											...
											if ((LA14_166 == 'w')) {
												...
												if ((LA14_169 == '+' || (LA14_169 >= '-' && LA14_169 <= ';')
														|| (LA14_169 >= 'A' && LA14_169 <= 'Z') || LA14_169 == '\\'
														|| LA14_169 == '_' || (LA14_169 >= 'a' && LA14_169 <= 'z'))) {
													alt14 = 47;
												} else {
													alt14 = 39;
												}
			...
			if ((LA14_23 == 'r')) {
				...
				if ((LA14_54 == 'u')) {
					...
					if ((LA14_76 == 'e')) {
						...
						if ((LA14_97 == '+' || (LA14_97 >= '-' && LA14_97 <= ';') || (LA14_97 >= 'A' && LA14_97 <= 'Z')
								|| LA14_97 == '\\' || LA14_97 == '_' || (LA14_97 >= 'a' && LA14_97 <= 'z'))) {
							alt14 = 47;
						} else {
							alt14 = 40;
						}
		...
		default:
			NoViableAltException nvae = new NoViableAltException(
					"1:1: Tokens : ( DOT | COMMA | SEMI | PERCENT | LPAR | RPAR | BLPAR | BRPAR | NOT | XOR | AT | NEQ | LT | GT | LTE | GTE | DEBUG | INFO | WARN | ERROR | FATAL | DEFINE | UNDEFINE | IF | ELIF | CONDITION | IFDEF | IFNDEF | ELIFDEF | ELIFNDEF | ENDIF | ELSE | ENDINCLUDE | INCLUDE | EXPAND | MDEBUG | ENDDEBUG | UNSET | ADD_IF_NEW | TRUE | FALSE | T60 | T61 | WS | ASLASH | EOL | SYMBOL | NUMBER | STRING | AND | OR | EQ );",
					14, 0, input);
